...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD3_Pin|Buzzer_Pin|Alarm_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD3_Pin Buzzer_Pin Alarm_LED_Pin */
  GPIO_InitStruct.Pin = LD3_Pin|Buzzer_Pin|Alarm_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
